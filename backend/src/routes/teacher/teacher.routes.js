...
router.put(
  '/topics/:id',
  validate(teacherValidation.updateTopic),
...
router.put(
  '/students/:studentId/registrations/:topicId',
  studentController.handleRegistration
);
router.delete(
  '/students/:studentId/topics/:topicId',
  studentController.removeStudentFromTopic
);
...
router.post(
  '/grading/submit/:topicId',
  validate(teacherValidation.submitGrades),
  gradingController.submitGrades
);
router.get('/grading/history', gradingController.getGradingHistory);

// Extended Teacher Routes
router.get('/rubric-evaluations', extendedController.getRubricEvaluations);
router.post(
  '/rubric-evaluations/:studentId',
  extendedController.submitRubricEvaluation
);
router.get('/councils', extendedController.getTeacherCouncils);
router.get('/students-progress', extendedController.getStudentsProgress);
router.get('/teaching-history', extendedController.getTeachingHistory);
router.get(
