...
const TopicDetail = () => {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#F8FAFC", pb: 10 }}>
      <Container maxWidth="xl" sx={{ pt: 6, mb: 8 }}>
        {/* Back Button */}
        <Button
        ...
        <Paper sx={{ ...glassCardSx, p: 4 }} elevation={0}>
          {/* Header */}
          <Grid
            container
          ...
          >
            ...
            <Grid item>
              {topic.student_info?.has_approved_topic ? (
                <Chip
                  icon={<CheckCircleIcon />}
                  label="Đã chốt đề tài"
                  color="success"
                  sx={{ borderRadius: "8px", fontWeight: 600, py: 2.5, px: 1, border: "1px solid #bbf7d0", bgcolor: "#dcfce7" }}
                />
                ...
                <Chip
                  ...
                  label="Đã tham gia"
                  color="success"
                  sx={{ borderRadius: "8px", fontWeight: 600, py: 2.5, px: 1 }}
                />
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Box mb={4}>
              ...
              >
                <DescriptionIcon sx={{ mr: 1, color: "primary.main" }} /> Mô tả
                đề tài
              </Typography>
              <Paper
                elevation={0}
              ...
              <Box mb={4}>
                ...
                <Paper
                  ...
                  sx={{
                    ...
                    borderRadius: "20px",
                    border: `1px solid ${alpha(warningMain, 0.2)}`,
                    color: warningMain,
                  }}
                >
            ...
            {(topic.topic_date || topic.topic_room) && (
              <Box mb={4}>
                ...
                >
                  <ScheduleIcon sx={{ mr: 1, color: "primary.main" }} /> Thông
                  tin bảo vệ
                </Typography>
          ...
          <Grid container spacing={4} sx={{ mt: 2 }}>
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                >
                  <PersonIcon sx={{ mr: 1, color: "primary.main" }} /> Giảng
                  viên hướng dẫn
                </Typography>
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                >
                  <SchoolIcon sx={{ mr: 1, color: "secondary.main" }} /> Người
                  đề xuất
                </Typography>
                <Box display="flex" alignItems="center">
                  <Avatar
